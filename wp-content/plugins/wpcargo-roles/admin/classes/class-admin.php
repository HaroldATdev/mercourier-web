...
class WCROL_Admin {
    ...
    public function handle_guardar_permisos(): void {
        ...
        WCROL_Permisos::guardar(
            $user_id,
            array_map('sanitize_key', $_POST['modulos'] ?? [])
        );
    ...
    public function handle_guardar_modulo(): void {
        ...
        wcrol_redirect(
            'wcrol-modulos',
            is_wp_error($r) ? 'error_req' : 'guardado'
        );
    }
