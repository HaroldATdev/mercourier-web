...
class WCROL_Admin
{
    ...
    {
        if (! current_user_can('wcrol_manage_roles')) wp_die('Sin permisos.');
        ...
        $permisos_u = $edit_uid ? WCROL_Permisos::obtener($edit_uid) : [];
    ...
    public function handle_guardar_permisos(): void
    {
        ...
        if (! current_user_can('wcrol_manage_roles')) wp_die();
