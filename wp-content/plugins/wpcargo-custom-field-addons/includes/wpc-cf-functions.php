...
function wpccf_get_woocommerce_currencies() {
...
function wpccf_get_woocommerce_currency_symbols() {
...
function wpccf_get_woocommerce_currency_symbol( $currency = '' ) {
	if ( ! $currency ) {
		$currency = 'PHP';
	}

	$symbols = wpccf_get_woocommerce_currency_symbols();

	$currency_symbol = isset( $symbols[ $currency ] ) ? $symbols[ $currency ] : '';

	return apply_filters( 'woocommerce_currency_symbol', $currency_symbol, $currency );
}
function wpccf_currency_list() {
	$list = array();
	foreach(wpccf_get_woocommerce_currencies() as $currency => $name) {
		$symbol = wpccf_get_woocommerce_currency_symbol($currency);
		$list[$currency] = "{$name} ({$symbol}) - {$currency}";
	}
	return $list;
}