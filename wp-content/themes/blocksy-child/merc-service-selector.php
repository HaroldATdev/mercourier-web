 ...
 * Evita cargar el formulario pesado de WPCargo en segundo plano hasta que se seleccione el servicio.
 */
?>
...
<style>
    ...
    .option-box-shipment p  { color: #666; font-size: 14px; line-height: 1.4; margin-bottom: 0; }
